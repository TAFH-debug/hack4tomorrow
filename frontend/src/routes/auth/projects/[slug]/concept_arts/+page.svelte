<script>
    ...
    import ConceptArt from '../../../../components/concept_art.svelte';
    ...
    function generate() {
        ...
        fetch("http://198.211.109.211:8000/concept_art/generate/", {
...
<div class="outer">
    ...
    <div id="popup" on:click={hide}>
        ...
        <div class="popup_cont" on:click={stopClick}>
            <div class="popup_title">Image details:</div>
            <input id="popup_input" class="popup_input" />
            <div class="popup_title">Concept art related to:</div>
    ...
    <div class="container">
        <span class="title">Concept Arts</span>
        <div class="projects">
            {#each data.concept_arts as concept_art}
            <ConceptArt concept_art={concept_art} username={data.username} password={data.password} slug={data.slug} entity_name={concept_art.entity_name}/>
            {/each}
